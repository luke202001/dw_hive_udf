...
import com.angejia.dw.hive.udaf.myMkCollectionEvaluator.BufferType;
import org.apache.hadoop.hive.serde2.typeinfo.TypeInfo;

@Description(name = "collect_list", value = "_FUNC_(x) - Returns a list of objects with duplicates")
public class myCollectList extends AbstractGenericUDAFResolver {
  ...
  public GenericUDAFEvaluator getEvaluator(TypeInfo[] parameters)
    ...
    return new myMkCollectionEvaluator(BufferType.LIST);
  }
}
